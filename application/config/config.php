...
|
*/
//$config['encryption_key'] = bin2hex(random_bytes(32)); // Secure 256-bit key
$config['encryption_key'] ='541beba6433ce6249f150332b66e309e471d81b170db49e48fde468466e18f21';
$config['encryption_driver'] = 'openssl';  // Ensure OpenSSL is used
$config['encryption_cipher'] = 'aes-256';  // Use AES-256
$config['encryption_mode'] = 'cbc';        // Use CBC mode
